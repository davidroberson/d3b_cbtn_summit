...
# Create API client with default configuration (from ~/.sevenbridges/credentials)
try:
    api = sb.Api(error_handlers=[rate_limit_sleeper, maintenance_sleeper])
    print(f"Using authentication from credentials file")
except Exception as e:
    print(f"Authentication failed: {str(e)}")
    print("Please run the credentials.py script first to set up your authentication.")
    sys.exit(1)
